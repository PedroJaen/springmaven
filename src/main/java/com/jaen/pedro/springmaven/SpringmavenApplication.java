...
public class SpringmavenApplication implements CommandLineRunner {
	...
	private static final Logger log = LoggerFactory.getLogger(SpringmavenApplication.class);
	...
	public void run(String... args) throws Exception {
		...
		List<Object[]> splitUpNames = Arrays.asList("John Woo2", "Jeff Dean2", "Josh Bloch2", "Josh Long2").stream()
